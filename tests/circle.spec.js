...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    const expectedCircum = 2 * 3.14 * 2;
    expect(circle(2).circumference).toBe(expectedCircum);
    ...
    const expectedCircumference= 2 * 3.14 * 3;
    expect(circle(3)).toEqual({radius: 3, area: expectedArea, circumference: expectedCircumference});
  });
});
